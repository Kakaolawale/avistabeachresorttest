    ...
    <section className="bg-gray-100 mb-4 py-2">
      <div className="container mx-auto px-4">
        ...
        <div className="flex items-center mx-2">
          <FaMapMarkerAlt className="text-avista2 text-2xl mr-2" />
          <p className="text-gray-800">Raliatu Olorunfunmike, Ajah</p>
        </div>
        <div className="flex items-center ml-2">
          <FaPhoneAlt className="text-avista2 text-2xl mr-2" />
          <p className="text-gray-800">+234803094217,+2349126035876</p>
        </div>
        </div>
      </div>
    </section>
