        ...
        <div className="px-6 py-8 bg-avista2 lg:flex-shrink-1 lg:p-12">
            ...
            <div className="mt-8">
                <div className="flex items-center">
                    <h4 className="flex-shrink-0 pr-4 text-sm font-semibold leading-5 tracking-wider text-avista3 uppercase bg-avista2 dark:bg-avista4">
                        STEPS TO MAKE PAYMENT
                    </h4>
                    <div className="flex-1 border-t-2 border-avista">
                    </div>
                </div>
                <ul className="mt-8 lg:grid lg:grid-cols-2 lg:col-gap-8 text-avista3 lg:row-gap-5">
                    ...
                    <li className="flex items-start lg:col-span-1">
                        ...
                        <p className="ml-3 text-sm leading-5 text-gray-700 dark:text-gray-200">
                            Wait for few seconds to recieve a response from our team
                        </p>
                    </li>
                    <li className="flex items-start lg:col-span-1">
                        <div className="flex-shrink-0">
                        ...
                        <p className="ml-3 text-sm leading-5 text-gray-700 dark:text-gray-200">
                            Make payment via bank transfer and send slip prove of payment
                        </p>
                    </li>
                    <li className="flex items-start lg:col-span-1">
                        <div className="flex-shrink-0">
                        ...
                        <p className="ml-3 text-sm leading-5 text-gray-700 dark:text-gray-200">
                            A reservation code will be sent to your mail for confirmation
                        </p>
                    </li>
                </ul>
            </div>
            <div className="mt-8">
                <div className="flex text-avista items-center">
                ...
                <ul className="mt-8 lg:grid lg:grid-cols-2 lg:col-gap-8 lg:row-gap-5">
                    <li className="flex items-start lg:col-span-1">
                        ...
                        <p className="ml-3 text-sm leading-5 text-avista">
        ...
        <div className="px-6 py-8 text-center bg-avista3 lg:flex-shrink-0 lg:flex lg:flex-col lg:justify-center lg:p-12">
            ...
            <div className="mt-6">
                <div className="rounded-md shadow">
                    <button type="button" className="font-bold py-2 px-4 bg-avista hover:bg-avista2 focus:ring-indigo-500 focus:ring-offset-indigo-200 text-white w-full transition ease-in duration-200 text-center text-base shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg ">
                        CONFIRM
                    </button>
                </div>
            </div>
