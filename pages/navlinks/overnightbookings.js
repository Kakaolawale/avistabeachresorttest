...
const BookingForm = () => {
  ...
  return (
    ...
    <form onSubmit={handleSubmit} className='flex flex-col md:flex-col shadow-xl backdrop-blur-lg items-center md:items-center 
    my-4 rounded-lg md:mx-2 md:rounded-2xl bg-gradient-to-br from-avista via-avista2
     py-4  px-18 mt-4 text-avista3' >

     
      <label className='md:mx-4 my-4 font-bold'>
        ...
        <label className='my-4 md:mx-1 font-bold'>
      ...
      <label className=' my-3 font-bold'>
        ...
        <input type="date" value={checkInDate} onChange={(e) => setCheckInDate(e.target.value)} className='text-avista2 px-1 rounded-lg' />
      </label>
      <label className='my-4  font-bold'>
      <span className='mr-2'>Check-Out Date</span>
        <input type="date" value={checkOutDate} onChange={(e) => setCheckOutDate(e.target.value)} className='text-avista2 px-1 rounded-lg' />
      </label>
      <label className='my-4  font-bold '>
      <span className='mr-2'>No. Rooms</span>
        <input type="number" value={numberOfRooms} onChange={(e) => setNumberOfRooms(e.target.value)} className='text-avista2 px-1 rounded-lg' />
      </label>
      <label className='my-4  font-bold '>
